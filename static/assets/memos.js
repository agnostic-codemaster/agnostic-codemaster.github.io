...
function updateHTMl(data) {
    ...
    var e = memos + "api/v1/memo/stats?creatorId=" + memo.creatorId;
    fetch(e)
        .then((e) => e.json())
        .then((e) => {
            e && (document.getElementById("memonums").innerHTML = e.length);
        });
}
